...
set DOCKER_APP_NAME=kagafon-cart-api
...
docker tag %DOCKER_APP_NAME%:%DOCKER_LATEST_TAG% %AWS_ACCOUNT_ID%.dkr.ecr.%REGION%.amazonaws.com/%DOCKER_APP_NAME%:%DOCKER_LATEST_TAG%
docker tag %DOCKER_APP_NAME%:%DOCKER_TIME_TAG% %AWS_ACCOUNT_ID%.dkr.ecr.%REGION%.amazonaws.com/%DOCKER_APP_NAME%:%DOCKER_TIME_TAG%
